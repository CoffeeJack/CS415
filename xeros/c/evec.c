...
/************************************
 * function name: my_set_evec
 * require: xnum = number between 48 and 255, handler = valid pointer to routine 
 * return: 
 * comment: used because set_evec cannot be directly called elsewhere
*************************************/
